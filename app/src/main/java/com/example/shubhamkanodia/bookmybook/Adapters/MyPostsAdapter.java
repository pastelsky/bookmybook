...
/**
 * Created by Chirag Shenoy on 26-Jun-15.
 */
public class MyPostsAdapter extends ArrayAdapter<BookItem> {
    Context context;
    ...
    public MyPostsAdapter(Context context, int textViewResourceId, ArrayList<BookItem> objects) {
